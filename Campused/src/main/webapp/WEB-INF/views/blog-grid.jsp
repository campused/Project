	...
	<div class="container">
		        ...
		        <div class="post">
		          ...
		          <div class="post-meta">
		            <ul>
		              ...
		              <li>
		                <a href="blog-grid"><i class="tf-ion-ios-pricetags"></i> LIFESTYLE</a>,<a href="blog-grid"> TRAVEL</a>, <a
		                href="blog-grid">FASHION</a>
		              </li>
		              <li>
			...
			<div class="col-md-6">
	          ...
	          <div class="post-meta">
	            <ul>
	              ...
	              <li>
	                <a href="blog-left-sidebar"><i class="tf-ion-ios-pricetags"></i> LIFESTYLE</a>,<a href="blog-left-sidebar"> TRAVEL</a>, <a
	                href="blog-left-sidebar">FASHION</a>
	              </li>
	              <li>
	                <a href="#!"><i class="tf-ion-chatbubbles"></i> 4 COMMENTS</a>
	              </li>
				...
				<div class="post">
					...
					<div class="post-meta">
						<ul>
							...
							<li>
								<a href="blog-right-sidebar"><i class="tf-ion-ios-pricetags"></i> LIFESTYLE</a>,<a href="blog-right-sidebar"> TRAVEL</a>, <a href="blog-right-sidebar">FASHION</a>
							</li>
							<li>
								<a href="#!"><i class="tf-ion-chatbubbles"></i> 4 COMMENTS</a>
							</li>
				...
				<div class="post">
					...
					<div class="post-meta">
						<ul>
							...
							<li>
								<a href="blog-full-width"><i class="tf-ion-ios-pricetags"></i> LIFESTYLE</a>,<a href="blog-full-width"> TRAVEL</a>, <a href="blog-full-width">FASHION</a>
							</li>
							<li>
								<a href="#!"><i class="tf-ion-chatbubbles"></i> 4 COMMENTS</a>
							</li>
		...
		<div class="text-center">
			<ul class="pagination post-pagination">
				<li><a href="blog-left-sidebar">Prev</a>
				</li>
				<li class="active"><a href="blog-left-sidebar">1</a>
				</li>
				<li><a href="blog-left-sidebar">2</a>
				</li>
				<li><a href="blog-left-sidebar">3</a>
				</li>
				<li><a href="blog-left-sidebar">4</a>
				</li>
				<li><a href="blog-left-sidebar">5</a>
				</li>
				<li><a href="blog-left-sidebar">Next</a>
				</li>
			</ul>
		</div>
  </div>
